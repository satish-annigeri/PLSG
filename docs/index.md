...
# Python Learning Support Group (PLSG)
![Python logo](img/python-logo-only-small.png){ align=left }

This is the home page of the **Python Learning Support Group (PLSG)**. It is a learning resource for the group engaged in learning Python for structural engineering applications.
